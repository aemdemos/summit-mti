...
- **Columns**: Fully content-driven video (author-editable thumbnail + URL), generic iframe lightbox supporting YouTube/Vimeo/Vidyard/Wistia/any embed URL, layout shift fix on play click
